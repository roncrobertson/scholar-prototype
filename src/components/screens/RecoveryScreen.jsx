...
export function RecoveryScreen() {
  ...
  return (
    <div className="fade-in space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Point Recovery</h1>
        <p className="text-gray-500">Missing work you can still submit</p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100">
        <div className="p-4 border-b border-gray-100">
          <h2 className="font-semibold text-gray-900">Missing assignments</h2>
        </div>
        
        {coursesWithMissing.length > 0 ? (
          coursesWithMissing.map(course => (
            <div key={course.id} className="p-4 border-b border-gray-50 last:border-0">
                ...
                <div key={i} className="bg-amber-50 rounded-xl p-4">
                  <div className="flex justify-between items-start">
                    ...
                    <div className="text-right">
                      <p className="text-sm font-medium text-amber-600">Due {work.deadline}</p>
          ...
          <div className="p-8 text-center">
            ...
            <p className="text-gray-500">No missing work. You're all caught up!</p>
          </div>
        )}
      </div>
      ...
      <div className="bg-white rounded-2xl border border-gray-100">
        <div className="p-4 border-b border-gray-100">
          <h2 className="font-semibold text-gray-900">Late work policies</h2>
        </div>
            ...
            <div key={course.id} className="p-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">{course.latePolicy.details}</p>
                </div>
              </div>
